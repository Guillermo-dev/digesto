...
export default function Search() {
    ...
    this.root = createElement("div")._class("Search")
        ._html(`<div class="container p-3 position-relative">
    ...
    const _selectedText = _searchForm.querySelectorAll(
        '[data-js="option-display"]'
    );
    ...
    function _fetchDocumentos() {
        ...
        documentosAPI.getDocumentos(
            ...
            (response) => {
                if (response.status === "success") {
                    _documentList.processDocumentos(
